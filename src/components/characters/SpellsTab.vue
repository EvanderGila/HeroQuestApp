<template>
  <div v-if="hasSpells" class="pt-2">
    ...
    <VRow dense>
      <VCol
        cols="12"
        :sm="props.oneCol ? '12' : '6'"
        v-for="cs in classSpells"
        :key="cs.spells.id"
        class="pa-1"
      >
        <VCard
          ...
          :class="[isLevelUnlocked(cs.required_lvl) ? 'unlocked-spell' : 'locked-spell']"
        >
            ...
            <div class="flex-grow-1 overflow-hidden">
              <div class="d-flex align-center justify-space-between flex-wrap gap-1 mb-1">
                ...
                <div class="d-flex align-center flex-shrink-0">
                  ...
                  <span
                    v-else
                    class="text-xxs text-disabled font-weight-bold tracking-wider text-uppercase"
                  >
                    Nv. {{ cs.required_lvl }}
                  </span>
                </div>
  ...
  <div v-else class="text-center py-8 text-medium-emphasis">
    ...
    <p class="text-caption">
      Tu clase actual no puede canalizar o aprender hechizos arcanos.
    </p>
  </div>
</template>
