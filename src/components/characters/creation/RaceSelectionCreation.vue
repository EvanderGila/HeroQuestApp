  ...
  <div>
    <div class="text-center">
      ...
      <p class="text-caption text-medium-emphasis mb-0">
        Tu linaje definirá tus capacidades, elije con cuidado.
      </p>
    </div>
            ...
            <VSheet class="d-flex fill-height align-center justify-center bg-transparent">
              ...
              >
                ...
                <VCardText class="py-3 hq-tabs-container border-top-thin">
                  <div
                    class="text-h5 font-weight-black text-uppercase tracking-wide text-warning"
                  >
                    {{ race.name }}
                  </div>
                </VCardText>
...
const { selectRace, draft } = useCharacterCreation()
