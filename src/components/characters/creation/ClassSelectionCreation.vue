<template>
  <div class="pa-2 pa-sm-3">
    <div class="text-center">
      <h4 class="text-h6 font-weight-black text-uppercase text-high-emphasis lh-tight">
        Elige tu Profesión
      </h4>
      <p class="text-caption text-medium-emphasis mb-0">
        Modificadores de entrenamiento, técnicas y magia.
      </p>
    </div>
    ...
    <VRow align="center" no-gutters>
      <VCol cols="12" md="7" class="d-flex align-center justify-center pa-2">
        ...
        >
          <VCarouselItem v-for="cls in compendiumStore.classes" :key="cls.id">
            <VSheet
              class="d-flex fill-height align-center justify-center bg-transparent pa-1"
            >
              <VCard
                width="200"
                class="border-thin bg-grey-darken-3 text-white rounded-xl elevation-8 text-center overflow-hidden"
              >
                <VImg
                ...
                <VCardText class="py-2 hq-tabs-container border-top-thin">
                  <div
                    class="text-subtitle-1 font-weight-black text-uppercase tracking-wide text-warning"
                  >
                    {{ cls.name }}
                  </div>
                </VCardText>
      ...
      <VCol cols="12" md="5" class="pa-2">
        <div
          ...
          class="hq-tabs-container border-thin pa-4 rounded-xl"
        >
    ...
    <div
      v-if="currentSelectedClass"
      class="hq-tabs-container border-thin pa-3 rounded-xl"
    >
      <VTabs v-model="activeTab" color="primary" density="compact" class="mb-2">
        ...
        <VTab v-if="hasSpells" value="spells" class="text-caption font-weight-bold">
          Hechizos
        </VTab>
      </VTabs>
...
const { selectClass, draft } = useCharacterCreation()
